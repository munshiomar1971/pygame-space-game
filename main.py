...
bg = pygame.transform.scale2x(bg_image)
...
#BULLET_HIT_SOUND = pygame.mixer.music.load('Assets/explosion.mp3')
#BULLET_FIRE_SOUND = pygame.mixer.music.load('Assets/fireshot.wav')
...
# draws windows
def draw_window(red, yellow, red_bullets, yellow_bullets, bg, red_health, yellow_health):
...
# red space ship movement
def hande_red_movement(keys_pressed, red):
...
def main():
	...
	while Running:
		...
		# keyboard input (Yellow SpaceShip)
		keys_pressed = pygame.key.get_pressed()
		handle_yellow_movement(keys_pressed, yellow)

		# keyboard input (Red SpaceShip)
		hande_red_movement(keys_pressed, red)

		draw_window(red, yellow, red_bullets, yellow_bullets, bg, red_health, yellow_health)
